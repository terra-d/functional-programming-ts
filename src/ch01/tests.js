...
QUnit.test('Listing 1.2 Extending printMessage', () => {
  ...
  const repeat = (times) => function (str = '') {
    const tokens = [];
...
QUnit.test('Listing 1.3 Imperative showStudent function with side effects', () => {
  ...
  function showStudent(ssn) {
    ...
    if (student !== null) {
      const studentInfo = `<p>${student.ssn},${student.firstname},${student.lastname}</p>`;
...
QUnit.test('Listing 1.5 Programming with function chains', () => {
