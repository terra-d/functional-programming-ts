...
describe('Chapter 5', () => {
  ...
  test('Maybe to extract a nested property in object graph', () => {
  ...
  test('Maybe to extract a missing nested property in object graph', () => {
  ...
  test('Using Either in show Student', () => {
  ...
  test('Monads as programmable commas', () => {
  ...
  test('Complete showStudent program', () => {
    // map :: (ObjectA -> ObjectB), Monad -> Monad[ObjectB]
    const map = R.curry((f, container) => container.map(f));
    // chain :: (ObjectA -> ObjectB), M -> ObjectB
    const chain = R.curry((f, container) => container.chain(f));
