...
describe('Chapter 4', () => {
  ...
  test('Chaining methods together', () => {
  ...
  test('Extending the core language', () => {
  ...
  test('Composition with functional libraries', () => {
    // Given data:
  ...
  test('Composition as point-free functions', () => {
    // Given data:
    const students = ['Rosser', 'Turing', 'Kleene', 'Church'];
    const grades = [80, 100, 90, 99];
  ...
  test('Show student program with currying and composition', () => {
